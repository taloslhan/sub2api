export default {
  ...
  usage: {
    ...
    cacheRead: '读取',
    cacheWrite: '写入',
    stateLength: 'State 长度（字节）',
    stateRequest: '请求',
    stateResponse: '响应',
    stateHandshakeRequest: '握手请求',
    stateHandshakeResponse: '握手响应',
    stateNotCollected: '未采集',
    stateReused: '复用',
    stateBytes: '字节',
    stateShowValue: '查看{source} State 原值',
    stateHandshakeNote: '来自该连接的握手快照，不代表本轮重新签发。',
    serviceTier: '服务档位',
    serviceTierPriority: 'Fast',
    serviceTierUltrafast: 'Ultrafast',
    serviceTierFlex: 'Flex',
    serviceTierStandard: 'Standard',
    cyberAccessProgram: 'Cyber 访问计划',
