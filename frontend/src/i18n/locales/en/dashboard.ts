export default {
  ...
  usage: {
    ...
    estimatedQuota: 'Estimated quota (account billed ÷ used %)',
    resetNow: 'Now',
    ...
    cacheRead: 'Read',
    cacheWrite: 'Write',
    stateLength: 'State length (bytes)',
    stateRequest: 'Request',
    stateResponse: 'Response',
    stateHandshakeRequest: 'Handshake request',
    stateHandshakeResponse: 'Handshake response',
    stateNotCollected: 'Not collected',
    stateReused: 'Reused',
    stateBytes: 'bytes',
    stateShowValue: 'Show {source} state value',
    stateHandshakeNote: 'Snapshot from this connection’s handshake, not a new state issued for this turn.',
    serviceTier: 'Service tier',
    serviceTierPriority: 'Fast',
    serviceTierUltrafast: 'Ultrafast',
    serviceTierFlex: 'Flex',
    serviceTierStandard: 'Standard',
    cyberAccessProgram: 'Cyber access program',
    cyberProgramDaybreakBlue: 'Daybreak Blue',
    cyberProgramDaybreakRed: 'Daybreak Red',
    cyberProgramStandard: 'Standard',
    rate: 'Rate',
    original: 'Original',
    billed: 'Billed',
