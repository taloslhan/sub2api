...
// CAPYBARA-PATCH: 既有账号统计用例显式锁定零值 profile 的原计费口径。
...
func TestTryModelFilePricing_Success(t *testing.T) {
	...
	tokens := UsageTokens{InputTokens: 100, OutputTokens: 50}
	result := tryModelFilePricing(bs, "claude-sonnet-4", tokens, "", time.Time{}, OpenAIBillingProfileUnknown, true)
	require.NotNil(t, result)
	// 100*0.001 + 50*0.002 = 0.1 + 0.1 = 0.2
	require.InDelta(t, 0.2, *result, 1e-12)
}
...
func TestTryModelFilePricing_Fable51HasNoImplicitReasoningMultiplier(t *testing.T) {
	...
	tokens := UsageTokens{InputTokens: 100}
	standard := tryModelFilePricing(bs, "claude-fable-5-1", tokens, "", time.Time{}, OpenAIBillingProfileUnknown, true, "xhigh")
	max := tryModelFilePricing(bs, "claude-fable-5-1", tokens, "", time.Time{}, OpenAIBillingProfileUnknown, true, "max")
...
func TestTryModelFilePricing_AppliesLongContextPricing(t *testing.T) {
	...
	result := tryModelFilePricing(bs, "gpt-5.6-sol", tokens, "", time.Time{}, OpenAIBillingProfileUnknown, true)
...
func TestTryModelFilePricing_AppliesServiceTierPricing(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := tryModelFilePricing(bs, "gpt-5.6-sol", tokens, tt.serviceTier, time.Time{}, OpenAIBillingProfileUnknown, true)
			require.NotNil(t, result)
...
func TestTryModelFilePricing_CombinesPriorityAndLongContextPricing(t *testing.T) {
	...
	result := tryModelFilePricing(bs, "gpt-5.6-sol", tokens, "priority", time.Time{}, OpenAIBillingProfileUnknown, true)
...
func TestTryModelFilePricing_PricingNotFound(t *testing.T) {
	...
	bs := newTestBillingServiceWithPrices(map[string]*ModelPricing{})
	tokens := UsageTokens{InputTokens: 100, OutputTokens: 50}
	result := tryModelFilePricing(bs, "nonexistent-model", tokens, "", time.Time{}, OpenAIBillingProfileUnknown, true)
	require.Nil(t, result)
}
			...
			t.Run(model.name+"/"+usage.name, func(t *testing.T) {
				...
				for _, slot := range []struct {
					...
					t.Run(slot.name, func(t *testing.T) {
						cost := tryModelFilePricing(bs, model.name, tokens, "", slot.at, OpenAIBillingProfileUnknown, true)
	...
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			cost := resolveAccountStatsCost(context.Background(), cs, newTestBillingService(),
				1, groupID, "deepseek-v4-flash", UsageTokens{InputTokens: 1000}, 1, 0.75, "", peak, OpenAIBillingProfileUnknown, true)
			if tt.noChannel {
				require.Nil(t, cost)
				return
			}
...
func TestResolveAccountStatsCost_NilChannelService(t *testing.T) {
	result := resolveAccountStatsCost(
		...
		1, 1, "claude-sonnet-4",
		UsageTokens{InputTokens: 100}, 1, 0.5, "", time.Time{}, OpenAIBillingProfileUnknown, true,
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_HitsCustomRule(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		tokens, 1, 999.0, "priority", time.Time{}, OpenAIBillingProfileUnknown, true, // 自定义账号价格不叠加服务层级倍率
	)
	require.NotNil(t, result)
...
func TestResolveAccountStatsCost_ApplyPricingToAccountStats_UsesTotalCost(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, nil,
		1, 10, "claude-sonnet-4",
		tokens, 1, 0.75, "priority", time.Time{}, OpenAIBillingProfileUnknown, true, // 已完成用户计费，不再重复应用服务层级倍率
	)
	require.NotNil(t, result)
...
func TestResolveAccountStatsCost_ApplyPricingToAccountStats_ZeroTotalCost_ReturnsNil(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, nil,
		1, 10, "claude-sonnet-4",
		UsageTokens{}, 1, 0.0, "", time.Time{}, OpenAIBillingProfileUnknown, true, // totalCost = 0
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_FallsBackToLiteLLM(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, bs,
		1, 10, "claude-sonnet-4",
		tokens, 1, 999.0, "", time.Time{}, OpenAIBillingProfileUnknown, true, // totalCost ignored
	)
	require.NotNil(t, result)
	// 100*0.001 + 50*0.002 = 0.1 + 0.1 = 0.2
	require.InDelta(t, 0.2, *result, 1e-12)
...
func TestResolveAccountStatsCost_FallbackHonorsAnthropicFast(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		1, 0, "fast", time.Time{}, OpenAIBillingProfileUnknown, true,
	)
	require.NotNil(t, result)
...
func TestResolveAccountStatsCost_Gemini36FlashTierUsesFallbackPricing(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		UsageTokens{InputTokens: 1_000_000, OutputTokens: 1_000_000, CacheReadTokens: 1_000_000}, 1, 0, "", time.Time{}, OpenAIBillingProfileUnknown, true,
	)
	require.NotNil(t, result)
...
func TestResolveAccountStatsCost_AllMiss_ReturnsNil(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		tokens, 1, 0.0, "", time.Time{}, OpenAIBillingProfileUnknown, true,
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_NilBillingService_SkipsLiteLLM(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		1, 10, "claude-sonnet-4",
		UsageTokens{InputTokens: 100}, 1, 0.0, "", time.Time{}, OpenAIBillingProfileUnknown, true,
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_CustomRulePriorityOverApplyPricing(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, nil,
		1, 10, "claude-sonnet-4",
		tokens, 1, 99.0, "", time.Time{}, OpenAIBillingProfileUnknown, true, // totalCost = 99.0 (would be used if ApplyPricing wins)
	)
	require.NotNil(t, result)
...
func TestApplyAccountStatsCost_UsesUsageLogServiceTier(t *testing.T) {
	...
	applyAccountStatsCost(
		...
		time.Time{}, OpenAIBillingProfileUnknown, true,
	)
