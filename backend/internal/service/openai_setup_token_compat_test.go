...
func TestOpenAISetupTokenMessagesUsesCodexBridgeAndTurnState(t *testing.T) {
	...
	require.NotNil(t, firstResult.TurnState)
	require.Empty(t, firstResult.TurnState.Request)
	require.Equal(t, "turn_state_setup", firstResult.TurnState.Response)
	...
	require.NotNil(t, secondResult.TurnState)
	require.Equal(t, "turn_state_setup", secondResult.TurnState.Request)
	require.Empty(t, secondResult.TurnState.Response)
