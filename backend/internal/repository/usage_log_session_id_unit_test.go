...
// precedes correlation_request_id and created_at.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 60, "arg-type table must include session_id and correlation_request_id")
	...
	// created_at is last; correlation_request_id follows session_id.
