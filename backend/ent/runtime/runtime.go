...
func init() {
	...
	// usagelogDescUpstreamCyberAccessProgram is the schema descriptor for upstream_cyber_access_program field.
	usagelogDescUpstreamCyberAccessProgram := usagelogFields[12].Descriptor()
	// usagelog.UpstreamCyberAccessProgramValidator is a validator for the "upstream_cyber_access_program" field. It is called by the builders before save.
	usagelog.UpstreamCyberAccessProgramValidator = usagelogDescUpstreamCyberAccessProgram.Validators[0].(func(string) error)
